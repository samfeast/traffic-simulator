...
{
   public:
    static VerticalProfile Linear(double horizontal_length, double elevation);

    static VerticalProfile Parabolic(double horizontal_length, double elevation, double initial_gradient);
   ...
   private:
    struct LinearData
    {
        VerticalProfilePose evaluate(double horizontal_length, double elevation, double length, double s) const;
    };
    ...
    VerticalProfile(double horizontal_length, double elevation, double length,
                    std::variant<LinearData, ParabolicData> data)
        : horizontal_length_(horizontal_length), elevation_(elevation), length_(length), data_(std::move(data))
    {
    }
